								...
								<div class="card-body p-3">
									<div class="d-sm-flex justify-content-between p-0">
										...
										<div class="d-flex">
											...
											<router-link to="/Pprofile" class="btn btn-icon btn-outline-dark ms-2 export">
												...
												<tr v-for="patien in Patiens" :key="patien.id">
													<td>
														<div class="d-flex align-items-center">
															...
															<p class="text-xs font-weight-bold ms-2 mb-0">{{ patien.id }}</p>
														</div>
													</td>
													<td class="font-weight-bold"><span
														class="my-2 text-xs">{{ patien.uname}}</span></td>
														<td class="font-weight-bold"><span
													...
													<td class="text-xs font-weight-bold"><span
														class="my-2 text-xs">{{ patien.tel }}</span></td>
														<td class="text-xs font-weight-bold"><span
														class="my-2 text-xs">{{ patien.bloodGroup }}</span></td>
														<td class="text-xs font-weight-bold p-0 pt-1">
  <button class="btn btn-outline-dark btn-xs p-1 mb-1 me-1" @click="deletePatient(patien.id)">Remove</button>
	<router-link :to="{ name: 'viewPro', params: { patientId: patien.id } }">
  ...
  methods: {
    ...
    deletePatient(patientId) {
        ...
        .then((response) => {
          ...
          this.Patiens = this.Patiens.filter((patient) => patient.patientId !== patientId);
