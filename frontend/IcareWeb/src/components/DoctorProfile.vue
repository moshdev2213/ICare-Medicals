            ...
            <div class="card-body">
              <form @submit.prevent="submitForm">
                ...
                <div class="mb-3">
                  ...
                  <p class="text-danger" v-if="!isValidTimeAvailable">Please enter a valid time available.</p>
                </div>
                <div class="mb-3">
                  ...
                  <p class="text-danger" v-if="!isValidDescription">Please enter a valid description.</p>
                </div>
                <div class="mb-3">
                  ...
                  <p class="text-danger" v-if="!isValidSpecialization">Please enter a valid specialization.</p>
                </div>
                <div class="mb-3">
                  ...
                  <p class="text-danger" v-if="!isValidStatus">Please enter a valid status.</p>
                </div>
                <div class="mb-3">
                  <label for="inputAmount" class="form-label">Amount</label>
                  <input type="number" class="form-control" id="inputAmount" v-model="doctor.amount" placeholder="Enter Amount" />
                  <p class="text-danger" v-if="!isValidAmount">Please enter a valid amount.</p>
                </div>
                <div class="mb-3">
                  ...
                  <p class="text-danger" v-if="!isValidCured">Please enter a valid number of cured cases.</p>
                </div>
                <div class="mb-3">
                  ...
                  <p class="text-danger" v-if="!isValidVenue">Please enter a valid venue.</p>
                </div>
                <div class="mb-3">
                  <label for="inputDate" class="form-label">Edited</label>
                  <input type="date" class="form-control" id="inputDate" v-model="doctor.edited" />
                  <p class="text-danger" v-if="!isValidEdited">Please enter a valid date.</p>
                </div>
                <div class="mb-3">
                  <label for="inputTelephone" class="form-label">Added</label>
                  <input type="text" class="form-control" id="inputTelephone" v-model="doctor.added" placeholder="Enter Added" />
                  <p class="text-danger" v-if="!isValidAdded">Please enter a valid added value.</p>
                </div>
