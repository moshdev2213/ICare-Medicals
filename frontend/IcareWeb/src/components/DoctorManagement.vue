                  ...
                  <tbody>
                    <tr v-for="doctor in Doctors" :key="doctor.id">
                      ...
                      <td class="font-weight-bold">
                        <span class="my-2 text-xs">{{ doctor.firstName }}</span>
                      </td>
                      <td class="font-weight-bold">
                        <span class="my-2 text-xs">{{ doctor.email }}</span>
                      </td>
                      <td class="font-weight-bold">
                      ...
                      <td class="text-xs font-weight-bold">
                        <span class="my-2 text-xs">{{ doctor.venue }}</span>
                      </td>
                      <td class="text-xs font-weight-bold">
                        <span class="my-2 text-xs">{{ doctor.edited }}</span>
                      </td>
                      <td class="text-xs font-weight-bold p-0 pt-1">
                        <button
                          class="btn btn-outline-dark btn-xs p-1 mb-1 me-1"
                          @click="deleteDoctors(doctor.id)"
                        >
                          Remove
                        </button>
                        <router-link
