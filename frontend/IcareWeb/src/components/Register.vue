<template>
    <div class="page-wrapper" id="main-wrapper" data-layout="vertical" data-navbarbg="skin6" data-sidebartype="full"
      ...
      <div
        ...
        <p class="text-danger" v-if="!isValidUname">Please enter a valid username.</p>
      </div>
      ...
      <div class="mb-4">
        ...
        <input type="password" class="form-control" v-model="admin.password" id="exampleInputPassword" placeholder="Enter your password">
        <p class="text-danger" v-if="!isValidPassword">Please enter a valid password (at least 8 characters).</p>
      </div>
                    <div class="mb-4">
...
export default {
  ...
  methods: {
    ...
    validateForm() {
      ...
      this.isFormValid = this.isValidUname && this.isValidEmail && this.isValidPassword;
    },
    isValidField(value) {
